...
const games = [
    ...
    { id: "slots", title: "Neon Slots", category: "Casino", bg: "url('assets/images/games/slots.jpg')", url: "pages/slots.html" },
    { id: "poker", title: "Cyber Poker", category: "Cards", bg: "url('assets/images/games/poker.jpg')", url: "pages/poker.html" },
    { id: "mines", title: "Neon Mines", category: "VIP Only", bg: "url('assets/images/games/mines.jpg')", url: "pages/mines.html", vip: true }
];
...
function initGatingLogic() {
    document.addEventListener('click', (e) => {
        ...
        const needsAuthBtn = e.target.closest('.play-btn') ||
        ...
        if (e.target.closest('.nav-item')) {
            ...
            if (text.includes("Inicio") || text.includes("Promociones") || text.includes("Juegos")) {
        ...
        if (needsAuthBtn) {
            ...
            if (!user) {
                ...
                e.stopPropagation();
                openLoginModal();
            } else if (e.target.closest('#addFundsBtn') || e.target.closest('.balance-display')) {
                e.preventDefault();
                e.stopPropagation();
        ...
        btnCreate.addEventListener('click', () => {
            ...
            if (typeof Storage !== 'undefined') {
                ...
                if (newUser) {
                    ...
                    if (typeof Notifications !== 'undefined') Notifications.success(`Bienvenido, ${name}`);
                } else {
                    if (typeof Notifications !== 'undefined') Notifications.error('El usuario ya existe o nombre inválido');
                }
            }
        });
    }
    ...
    document.addEventListener('click', (e) => {
        ...
        if (profileCard && loginModal && loginModal.open) {
            ...
            if (typeof Storage !== 'undefined') {
                ...
                loginModal.close();
                if (typeof Notifications !== 'undefined') Notifications.success(`Sesión iniciada como ${username}`);
