/*
  Neon Mines game logic:
  - Inicializa la cuadrícula de minas y controla la apuesta.
  - Revela gemas, evita bombas y calcula el multiplicador de retirada.
*/
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Crea una cuadrícula de 25 casillas y asigna el evento de click a cada tile.
  function initGrid() {
  ...
  // Inicia la partida: valida apuesta, descuenta saldo, reinicia contadores y distribuye las minas.
  function startGame() {
  ...
  // Calcula el multiplicador actual según cuántas gemas se han revelado sin pisar minas.
  ...
  function clickTile(index) {
    ...
    if (
      tile.classList.contains("revealed-gem") ||
      tile.classList.contains("revealed-bomb")
    )
      return;
  ...
  function cashout() {
    ...
    Notifications.success(
      `¡Retiro exitoso a ${currentMultiplier.toFixed(2)}x!`,
    );
