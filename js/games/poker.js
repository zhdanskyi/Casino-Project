document.addEventListener('DOMContentLoaded', () => {
    ...
    function resolveGame(playerFolded) {
        ...
        if (playerScore > dealerScore) {
            ...
            Notifications.success(`¡Ganaste el bote de ${Formatter.number(pot)} EUR!`);
    ...
    if (elements.btnFold) elements.btnFold.addEventListener('click', () => {
        resolveGame(true);
    });

    if (elements.btnCall) elements.btnCall.addEventListener('click', () => {
        nextPhase();
    });
