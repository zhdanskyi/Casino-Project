/*
  ...
  - Controla el usuario activo, saldos, transacciones y estadísticas.
*/
...
// Guarda los datos del usuario en localStorage y notifica a la aplicación del cambio.
...
// Reinicia el almacenamiento de usuarios y dispara un evento global de actualización.
...
// Actualiza el balance del usuario con un ingreso o gasto, y registra la transacción.
...
// Compra el estatus VIP si el usuario tiene saldo suficiente.
...
const Storage = {
  ...
  // Registra un nuevo usuario con saldo inicial y datos básicos.
